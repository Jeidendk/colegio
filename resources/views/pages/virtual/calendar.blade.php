<div class="virtual-page-heading calendar-heading"><div><small>AULA VIRTUAL</small><h1>Calendario académico</h1><p>Actividades, entregas y eventos de todos tus cursos.</p></div><button class="pill-button solid" type="button" data-modal-open="calendar-event-modal"><i data-lucide="plus"></i> Nuevo evento</button></div>
...
<div class="modal" id="calendar-detail-modal" aria-hidden="true"><div class="modal-card"><button class="modal-close" data-modal-close>×</button><small class="modal-kicker">31 DE AGOSTO · 23:59</small><h2>Cuestionario: Flujo de potencia</h2><p class="modal-copy">Evaluación de la Unidad 2 del curso Sistemas Eléctricos de Potencia.</p><a class="pill-button solid" href="{{ route('portal',['role'=>$role,'page'=>'aula-virtual','curso'=>'sistemas-potencia']) }}">Ir a la actividad</a></div></div>

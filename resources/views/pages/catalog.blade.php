...
<aside class="cart-drawer" data-cart-drawer aria-hidden="true"><div class="cart-head"><div><small>SOLICITUD</small><h2>Equipos seleccionados</h2></div><button class="icon-button" data-close-cart>×</button></div><div class="cart-items" data-cart-items><div class="empty-cart"><i data-lucide="shopping-basket"></i><p>Aún no agregas equipos.</p></div></div><div class="cart-form"><label class="export-field">Asignatura<select><option>Matemática</option><option>Ciencias Naturales</option><option>Lengua y Literatura</option></select></label><label class="export-field">Fecha de uso<input type="date" value="2026-09-02"></label><label class="export-field">Observación<textarea placeholder="Detalle del uso previsto (opcional)"></textarea></label><button class="primary-button dark" type="button" data-submit-cart><i data-lucide="send"></i> Generar solicitud</button></div></aside><div class="drawer-backdrop" data-close-cart></div>
